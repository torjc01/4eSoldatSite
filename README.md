...
```bash
docker build -t juliozohar/4esoldat:1.9.1 .
docker push juliozohar/4esoldat:1.9.1
```

Execute o container 

```bash
docker run -d -p 3000:3000 juliozohar/4esoldat:1.9.1 &
```
...
```bash
docker exec -it juliozohar/4esoldat:1.9 /bin/sh &
```
